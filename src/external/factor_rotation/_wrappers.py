...
class unittests(unittest.TestCase):
    ...
    def _test_template(self, method,*method_args, **algorithms):
        A=self.get_A()
        algorithm1= 'gpa' if not 'algorithm1' in algorithms else algorithms['algorithm1']
        algorithm2= 'gpa_der_free' if not 'algorithm1' in algorithms else algorithms['algorithm1']
